...
namespace EdgeComputerSimulator.Console.RequestsHandler.Helpers
{
    ...
    public static class GatewaysRetriever
    {
        ...
        public static async Task Execute()
        {
            ...
            try
            {
                ...
                {
                    System.Console.WriteLine($"ID STATION: {station.Id}");
                }
                foreach (var gateway in gateways)
                {
                    System.Console.WriteLine($"ID GATEWAY: {gateway.Id}");
                }
        ...
        public static void GatewaysCollectionInitialization(List<GatewayListDto> gateways, List<ColumnListDto> columns)
        {
            if (gateways is null)
            {
                System.Console.WriteLine("No gateways found in the db.");
                return;
            }
